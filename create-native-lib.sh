...
g++ -fPIC -I"$JAVA_HOME/include" -I"$JAVA_HOME/include/linux" -Lcore/build/bin -lgps -shared -o lib/libmap.so src/native/*.cpp src/native/core/*.cpp core/src/core/API/interface.cpp core/src/core/API/interface.hpp
